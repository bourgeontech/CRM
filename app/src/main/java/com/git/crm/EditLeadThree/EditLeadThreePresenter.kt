...
class EditLeadThreePresenter(var loginview: EditLeadThreeView?, val loginInteractor: EditLeadThreeInteractor) :
    EditLeadThreeInteractor.OnLoginFinishedListener {
