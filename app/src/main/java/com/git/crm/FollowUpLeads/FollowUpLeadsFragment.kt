...
class FollowUpLeadsFragment : Fragment(), FollowUpLeadView {
    ...
    private val presenter=FollowUpLeadPresenter(this, PollowUpLeadInteractor())
...
//    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as MainActivity?)!!.heading("New Follow Ups")
...
//                }
        ...
        tvSearch.setOnClickListener {
            presenter.lead(userId!!, "4",date, date2, "added", "0", "10", edtSearch.text.toString())
