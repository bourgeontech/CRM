...
class ConvertedLeadsFragment : Fragment(), ConvertedLeadView {
    ...
    private val presenter = ConvertedLeadPresenter(this, ConvertedLeadInteractor())
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as MainActivity?)!!.heading("Converted")
