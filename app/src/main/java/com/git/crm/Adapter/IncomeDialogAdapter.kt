...
class IncomeDialogAdapter(
    var activity: FragmentActivity?,
    val fragmentManager: FragmentManager?,
    val doctorlist: List<IncomeList>

) : RecyclerView.Adapter<IncomeDialogAdapter.BusListDialogViewHolder>() {
...
//
        holder.txtName.setOnClickListener {
            ...
            onBusdetailsval.onBus(
                    doctorlist.get(position).id!!.toString(),doctorlist.get(position).value!!)
