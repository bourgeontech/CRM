...
import kotlinx.android.synthetic.main.row_current.view.tvMake
import kotlinx.android.synthetic.main.row_current.view.tvModel
import kotlinx.android.synthetic.main.row_suggest.view.*


class SuggestAdapter(
    val itemsCells: List<SuggestedVehicle>?,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return if (viewType == Constant.VIEW_TYPE_ITEM) {
            val view = LayoutInflater.from(parent.context)
                .inflate(com.git.crm.R.layout.row_suggest, parent, false)
            ItemViewHolder(view)
        } else {
            val view =
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder.itemViewType == Constant.VIEW_TYPE_ITEM) {
           // holder.itemView.tvDate.text = itemsCells?.get(position)?.createdDate
            ...
            holder.itemView.tvNumber.text ="Vehicle Number : "+itemsCells?.get(position)?.TestDriveNo
