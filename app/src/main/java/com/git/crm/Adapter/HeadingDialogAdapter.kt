...
class HeadingDialogAdapter(
    var activity: FragmentActivity?,
    val fragmentManager: FragmentManager?,
    val doctorlist: List<HeadingList>,
    var headinglist: ArrayList<String>

) : RecyclerView.Adapter<HeadingDialogAdapter.BusListDialogViewHolder>() {
    ...
    fun filterList(filternames: ArrayList<String>) {
        try {
            headinglist = filternames
    ...
    override fun onBindViewHolder(holder: BusListDialogViewHolder, position: Int) {
        ...
        holder.txtName.text = headinglist.get(position)
...
//
        holder.txtName.setOnClickListener {
            ...
            onBusdetailsval.onBus(
                headinglist.get(position)!!,headinglist.get(position)!!)
