...
import com.git.crm.Pojo.CurrentVehicle
...
import kotlinx.android.synthetic.main.row_current.view.*


class CurrentAdapter(
    val itemsCells: List<CurrentVehicle>?,
...
//    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return if (viewType == Constant.VIEW_TYPE_ITEM) {
            val view = LayoutInflater.from(parent.context)
                .inflate(com.git.crm.R.layout.row_current, parent, false)
            ItemViewHolder(view)
        } else {
            val view =
                LayoutInflater.from(mcontext)
                    .inflate(com.git.crm.R.layout.progress_loading, parent, false)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder.itemViewType == Constant.VIEW_TYPE_ITEM) {
            ...
            holder.itemView.tvMake.text = "Make : " + itemsCells?.get(position)?.make
            holder.itemView.tvModel.text = "Model : " + itemsCells?.get(position)?.model
            if (itemsCells?.get(position)?.variant == null)
                holder.itemView.tvVariant.text = "Variant : NA"
            else
                holder.itemView.tvVariant.text = "Variant : " + itemsCells?.get(position)?.variant
            holder.itemView.tvYear.text = "Year : " + itemsCells?.get(position)?.year
