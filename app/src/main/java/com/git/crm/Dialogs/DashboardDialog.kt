...
import com.git.crm.Adapter.DashboardDialogAdapter

import com.git.crm.R
import kotlinx.android.synthetic.main.fragment_type_list.*


class DashboardDialog(val doctorList: MutableList<String>) : DialogFragment() {
    ...
    private lateinit var busdetailsval: DashboardDialogAdapter.OnBusdetails;
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        txtHeading.setText("Choose")
        busdetailsval = object : DashboardDialogAdapter.OnBusdetails {
        ...
        val adapter = DashboardDialogAdapter(activity, fragmentManager,doctorList)
