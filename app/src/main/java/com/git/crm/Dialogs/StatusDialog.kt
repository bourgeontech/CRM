...
import com.git.crm.Adapter.StatusDialogAdapter

import com.git.crm.R
import kotlinx.android.synthetic.main.fragment_type_list.*


class StatusDialog(val doctorList: MutableList<String>) : DialogFragment() {
    ...
    private lateinit var busdetailsval: StatusDialogAdapter.OnBusdetails;
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        txtHeading.setText("Select Status")
        busdetailsval = object : StatusDialogAdapter.OnBusdetails {
        ...
        val adapter = StatusDialogAdapter(activity, fragmentManager,doctorList)
