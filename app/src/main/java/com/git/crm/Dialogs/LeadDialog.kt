...
import com.git.crm.Adapter.LeadDialogAdapter

import com.git.crm.Pojo.LeadList
import com.git.crm.R
import kotlinx.android.synthetic.main.fragment_type_list.*


class LeadDialog(val doctorList: List<LeadList>) : DialogFragment() {
    ...
    private lateinit var busdetailsval: LeadDialogAdapter.OnBusdetails;
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        txtHeading.setText("Select Lead Status")
        busdetailsval = object : LeadDialogAdapter.OnBusdetails {
        ...
        val adapter = LeadDialogAdapter(activity, fragmentManager,doctorList)
